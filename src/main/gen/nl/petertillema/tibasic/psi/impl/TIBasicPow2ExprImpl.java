...
public class TIBasicPow2ExprImpl extends TIBasicExprImpl implements TIBasicPow2Expr {

  public TIBasicPow2ExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitPow2Expr(this);
  }
