...
public class TIBasicIsDsStatementImpl extends TIBasicStatementImpl implements TIBasicIsDsStatement {

  public TIBasicIsDsStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitIsDsStatement(this);
  }
