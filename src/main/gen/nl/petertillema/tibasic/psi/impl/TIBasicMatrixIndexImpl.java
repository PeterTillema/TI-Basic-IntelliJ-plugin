...
public class TIBasicMatrixIndexImpl extends ASTWrapperPsiElement implements TIBasicMatrixIndex {

  public TIBasicMatrixIndexImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitMatrixIndex(this);
  }
