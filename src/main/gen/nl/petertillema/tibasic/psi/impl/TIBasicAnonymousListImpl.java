...
public class TIBasicAnonymousListImpl extends ASTWrapperPsiElement implements TIBasicAnonymousList {

  public TIBasicAnonymousListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitAnonymousList(this);
  }
