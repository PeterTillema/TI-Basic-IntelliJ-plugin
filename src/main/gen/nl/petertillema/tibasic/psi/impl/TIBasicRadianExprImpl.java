...
public class TIBasicRadianExprImpl extends TIBasicExprImpl implements TIBasicRadianExpr {

  public TIBasicRadianExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitRadianExpr(this);
  }
