...
public class TIBasicFracExprImpl extends TIBasicExprImpl implements TIBasicFracExpr {

  public TIBasicFracExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitFracExpr(this);
  }
