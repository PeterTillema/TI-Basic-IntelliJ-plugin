...
public class TIBasicCustomListImpl extends ASTWrapperPsiElement implements TIBasicCustomList {

  public TIBasicCustomListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitCustomList(this);
  }
