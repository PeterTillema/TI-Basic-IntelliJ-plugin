...
public class TIBasicMenuStatementImpl extends TIBasicStatementImpl implements TIBasicMenuStatement {

  public TIBasicMenuStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitMenuStatement(this);
  }
  ...
  @Override
  @NotNull
  public List<TIBasicMenuOption> getMenuOptionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, TIBasicMenuOption.class);
  }
