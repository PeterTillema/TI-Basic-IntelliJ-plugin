...
public class TIBasicXrootExprImpl extends TIBasicExprImpl implements TIBasicXrootExpr {

  public TIBasicXrootExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitXrootExpr(this);
  }
