...
public class TIBasicPlotStatementImpl extends TIBasicStatementImpl implements TIBasicPlotStatement {

  public TIBasicPlotStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitPlotStatement(this);
  }
