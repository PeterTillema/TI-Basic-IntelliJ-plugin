...
public class TIBasicNcrExprImpl extends TIBasicExprImpl implements TIBasicNcrExpr {

  public TIBasicNcrExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitNcrExpr(this);
  }
