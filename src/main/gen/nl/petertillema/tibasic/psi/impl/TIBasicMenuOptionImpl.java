...
public class TIBasicMenuOptionImpl extends ASTWrapperPsiElement implements TIBasicMenuOption {

  public TIBasicMenuOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitMenuOption(this);
  }
