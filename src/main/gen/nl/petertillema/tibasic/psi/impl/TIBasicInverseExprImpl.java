...
public class TIBasicInverseExprImpl extends TIBasicExprImpl implements TIBasicInverseExpr {

  public TIBasicInverseExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitInverseExpr(this);
  }
