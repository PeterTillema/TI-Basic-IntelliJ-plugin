...
public class TIBasicDmsExprImpl extends TIBasicExprImpl implements TIBasicDmsExpr {

  public TIBasicDmsExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitDmsExpr(this);
  }
