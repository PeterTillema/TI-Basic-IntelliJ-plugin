...
public class TIBasicImpliedMulExprImpl extends TIBasicExprImpl implements TIBasicImpliedMulExpr {

  public TIBasicImpliedMulExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitImpliedMulExpr(this);
  }
