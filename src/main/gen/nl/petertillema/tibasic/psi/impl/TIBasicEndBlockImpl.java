...
public class TIBasicEndBlockImpl extends ASTWrapperPsiElement implements TIBasicEndBlock {

  public TIBasicEndBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitEndBlock(this);
  }
