...
public class TIBasicNprExprImpl extends TIBasicExprImpl implements TIBasicNprExpr {

  public TIBasicNprExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitNprExpr(this);
  }
