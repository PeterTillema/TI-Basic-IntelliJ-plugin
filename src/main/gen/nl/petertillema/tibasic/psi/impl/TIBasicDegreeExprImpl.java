...
public class TIBasicDegreeExprImpl extends TIBasicExprImpl implements TIBasicDegreeExpr {

  public TIBasicDegreeExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitDegreeExpr(this);
  }
