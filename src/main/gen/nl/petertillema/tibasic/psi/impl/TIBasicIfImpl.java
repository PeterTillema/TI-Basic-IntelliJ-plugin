...
public class TIBasicIfImpl extends ASTWrapperPsiElement implements TIBasicIf {

  public TIBasicIfImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public TIBasicThen getThen() {
    return findChildByClass(TIBasicThen.class);
  }
