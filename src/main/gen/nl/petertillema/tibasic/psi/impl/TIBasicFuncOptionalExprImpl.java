...
public class TIBasicFuncOptionalExprImpl extends TIBasicExprImpl implements TIBasicFuncOptionalExpr {

  public TIBasicFuncOptionalExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TIBasicVisitor visitor) {
    visitor.visitFuncOptionalExpr(this);
  }
