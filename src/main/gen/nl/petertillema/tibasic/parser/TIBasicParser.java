...
public class TIBasicParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // DIM LPAREN (LIST_VARIABLE | custom_list | MATRIX_VARIABLE) optional_rparen
  ...
  // LIST_VARIABLE | custom_list | MATRIX_VARIABLE
  private static boolean assignment_target_dim_2(PsiBuilder b, int l) {
    ...
    if (!r) r = custom_list(b, l + 1);
    if (!r) r = consumeToken(b, MATRIX_VARIABLE);
    return r;
  }

  /* ********************************************************** */
  // (LIST_VARIABLE | custom_list) LPAREN expr optional_rparen
  ...
  /* ********************************************************** */
  // LIST_VARIABLE | custom_list | custom_list_name | EQUATION_VARIABLE | STRING_VARIABLE | SIMPLE_VARIABLE | MATRIX_VARIABLE | WINDOW_VARIABLE
  ...
  public static boolean custom_list(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "custom_list")) return false;
    if (!nextTokenIs(b, CUSTOM_LIST_L)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, CUSTOM_LIST_L);
    r = r && custom_list_name(b, l + 1);
    exit_section_(b, m, CUSTOM_LIST, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // DELVAR (LIST_VARIABLE | custom_list | EQUATION_VARIABLE | STRING_VARIABLE | SIMPLE_VARIABLE | MATRIX_VARIABLE | WINDOW_VARIABLE | PICTURE_VARIABLE)
  ...
  // LIST_VARIABLE | custom_list | EQUATION_VARIABLE | STRING_VARIABLE | SIMPLE_VARIABLE | MATRIX_VARIABLE | WINDOW_VARIABLE | PICTURE_VARIABLE
  ...
  /* ********************************************************** */
  // LPAREN for_identifier COMMA expr COMMA expr [COMMA expr] optional_rparen
  static boolean for_header(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, consumeToken(b, COMMA)) && r;
    r = p && report_error_(b, expr(b, l + 1, -1)) && r;
    r = p && report_error_(b, for_header_6(b, l + 1)) && r;
    r = p && optional_rparen(b, l + 1) && r;
    exit_section_(b, l, m, r, p, TIBasicParser::recover_until_newline);
    return r || p;
  }

  // [COMMA expr]
  private static boolean for_header_6(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "for_header_6")) return false;
    for_header_6_0(b, l + 1);
    return true;
  }

  // COMMA expr
  private static boolean for_header_6_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "for_header_6_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  public static boolean for_statement(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, for_header(b, l + 1));
    r = p && loop_block(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  /* ********************************************************** */
  // IF loop_condition NEWLINE if_body
  ...
  /* ********************************************************** */
  // expr optional_rparen
  static boolean is_ds_condition(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "is_ds_condition")) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = expr(b, l + 1, -1);
    p = r; // pin = 1
  ...
  /* ********************************************************** */
  // (IS | DS) LPAREN SIMPLE_VARIABLE COMMA is_ds_condition NEWLINE statement_internal
  public static boolean is_ds_statement(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, is_ds_condition(b, l + 1)) && r;
    r = p && report_error_(b, NEWLINE(b, l + 1)) && r;
  ...
  /* ********************************************************** */
  // (LIST_VARIABLE | ANS_VARIABLE | custom_list) LPAREN expr optional_rparen
  ...
  // LIST_VARIABLE | ANS_VARIABLE | custom_list
  ...
  static boolean loop_block(PsiBuilder b, int l) {
  ...
  /* ********************************************************** */
  // expr
  static boolean loop_condition(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "loop_condition")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_);
    r = expr(b, l + 1, -1);
    exit_section_(b, l, m, r, false, TIBasicParser::recover_until_newline);
    return r;
  }

  /* ********************************************************** */
  // ANS_VARIABLE LPAREN expr COMMA expr optional_rparen
  static boolean matrix_ans_index(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "matrix_ans_index")) return false;
    if (!nextTokenIs(b, ANS_VARIABLE)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeTokens(b, 0, ANS_VARIABLE, LPAREN);
    r = r && expr(b, l + 1, -1);
  ...
  /* ********************************************************** */
  // matrix_normal_index | matrix_ans_index
  public static boolean matrix_index(PsiBuilder b, int l) {
    ...
    r = matrix_normal_index(b, l + 1);
    if (!r) r = matrix_ans_index(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  /* ********************************************************** */
  // MATRIX_VARIABLE LPAREN expr COMMA expr optional_rparen
  static boolean matrix_normal_index(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "matrix_normal_index")) return false;
    if (!nextTokenIs(b, MATRIX_VARIABLE)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeTokens(b, 2, MATRIX_VARIABLE, LPAREN);
  ...
  public static boolean plot_statement(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, PLOT_STATEMENT, null);
    r = consumeTokens(b, 1, PLOT_COMMAND, LPAREN, PLOT_TYPE, COMMA);
    p = r; // pin = 1
    r = r && report_error_(b, expr(b, l + 1, -1));
    r = p && report_error_(b, consumeToken(b, COMMA)) && r;
    r = p && report_error_(b, expr(b, l + 1, -1)) && r;
    r = p && report_error_(b, plot_statement_7(b, l + 1)) && r;
    r = p && report_error_(b, plot_statement_8(b, l + 1)) && r;
    r = p && optional_rparen(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  /* ********************************************************** */
  // !NEWLINE
  static boolean recover_until_newline(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "recover_until_newline")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NOT_);
    r = !NEWLINE(b, l + 1);
    exit_section_(b, l, m, r, false, null);
  ...
  /* ********************************************************** */
  // REPEAT loop_condition [NEWLINE loop_block]
  public static boolean repeat_statement(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, loop_condition(b, l + 1));
    r = p && repeat_statement_2(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // [NEWLINE loop_block]
  private static boolean repeat_statement_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "repeat_statement_2")) return false;
    repeat_statement_2_0(b, l + 1);
    return true;
  }

  // NEWLINE loop_block
  private static boolean repeat_statement_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "repeat_statement_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = NEWLINE(b, l + 1);
    r = r && loop_block(b, l + 1);
  ...
  /* ********************************************************** */
  // WHILE loop_condition [NEWLINE loop_block]
