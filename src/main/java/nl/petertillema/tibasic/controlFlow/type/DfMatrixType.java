...
public class DfMatrixType implements DfType {
    ...
    public boolean isSuperType(@NotNull DfType other) {
        ...
        if (!(other instanceof DfMatrixType o)) return false;
    ...
    public @NotNull DfType join(@NotNull DfType other) {
        ...
        if (!(other instanceof DfMatrixType o)) return DfType.TOP;
    ...
    public @Nullable DfType tryJoinExactly(@NotNull DfType other) {
        ...
        if (!(other instanceof DfMatrixType o)) return null;
    ...
    public @NotNull DfType meet(@NotNull DfType other) {
        ...
        if (!(other instanceof DfMatrixType o)) return DfType.BOTTOM;
