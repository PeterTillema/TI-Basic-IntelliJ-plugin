...
public final class DCSMonochrome16IconEditorPanel extends AbstractDCSIconEditorPanel {

    private final char[] data = new char[64];

    public DCSMonochrome16IconEditorPanel(String iconData) {
        super(false);
